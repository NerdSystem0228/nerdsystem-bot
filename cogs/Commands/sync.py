...
class Sync(commands.Cog):
    ...
    async def status_ctx(self, ctx):
        cmds = await ctx.bot.tree.sync(guild=discord.Object(id=os.getenv("SYSTEM_SERVER")))
    ...
    async def sync(self, interaction: Interaction):
        cmds = await self.bot.tree.sync(guild=discord.Object(id=os.getenv("SYSTEM_SERVER")))
